function openMetadata(type, fig_number) {
    ...
    const design_fig_info = [
                            ['A poster about Fusarium wilt, also known as Panama Disease, which affects Cavendish bananas that could lead to less production of bananas in the future. The virus that was a predecessor of Fusarium wilt has been the leading cause for the demise of Gros Michel banana species. Read more on <a href="library/tr4disease.html">here</a>.'],
